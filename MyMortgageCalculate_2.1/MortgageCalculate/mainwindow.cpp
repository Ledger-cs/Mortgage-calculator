    ...
    , ui(new Ui::MainWindow)
{
    ...
    pRegVld->setRegExp(QRegExp(QString("\\d{1,4}(\\.\\d{1,4})?")));
    ui->lineEdit->setValidator(pRegVld);
    ui->lineEdit_2->setValidator(pRegVld);
    ui->lineEdit_3->setValidator(pRegVld);
    ui->lineEdit_4->setValidator(pRegVld);
    QRegExpValidator * pRegVld1 = new QRegExpValidator(this);
    pRegVld1->setRegExp(QRegExp(QString("\\d{1,2}(\\.\\d{1,2})?")));
    ui->lineEdit_5->setValidator(pRegVld1);
    ui->lineEdit_6->setValidator(pRegVld1);
}
