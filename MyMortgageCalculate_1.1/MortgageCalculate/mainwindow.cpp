...
void MainWindow::on_pushButton_clicked()
{
    ...
    if(dkfs == 2)     //   组合贷款
    {
        ...
        if(hkfs == 0)
        {
            dkze = sTotal+gTotal;
            double f1,f2;
            f1 = (sTotal*srate/12/100*pow(1+srate/12/100,ys))/(pow(1+srate/12/100,ys)-1);
            f2 = (gTotal*grate/12/100*pow(1+grate/12/100,ys))/(pow(1+grate/12/100,ys)-1);
            yuegong = f1 + f2;
            hkze = yuegong*ys;
            lixi = hkze - dkze;
        ...
        if(hkfs == 1)
        {
            ...
            double f1,f2;
            f1 = sTotal/ys*srate/12/100;
            f2 = gTotal/ys*grate/12/100;
            mydj = f1 + f2;
